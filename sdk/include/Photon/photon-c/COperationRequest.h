...
extern "C"
{
	...
	COperationRequest* OperationRequest_create(nByte opCode, EG_HashTable parameters);
	COperationRequest* OperationRequest_init(COperationRequest* pOperationRequest, nByte opCode, EG_HashTable parameters);
	...
	EG_HashTable* OperationRequest_getParameters(COperationRequest* pOperationRequest);
#ifdef __cplusplus
}
#endif 
