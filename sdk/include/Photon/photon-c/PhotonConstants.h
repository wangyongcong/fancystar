...
#define P_CACHE            ((nByte)247)
#define P_RECEIVER_GROUP   ((nByte)246)
...
// Event Caching
#define EVC_DO_NOT_CACHE  ((nByte)0)
#define EVC_MERGE_CACHE   ((nByte)1)
#define EVC_REPLACE_CACHE ((nByte)2)
#define EVC_REMOVE_CACHE  ((nByte)3)

// ReceiverGroups
#define RG_OTHERS        ((nByte)0)
#define RG_ALL           ((nByte)1)
#define RG_MASTER_CLIENT ((nByte)2)
...
#define IN_BUFF_HEADER_LENGTH 2
#define INIT_BYTES_HEADER_LENGTH (IN_BUFF_HEADER_LENGTH+7)
#define APP_NAME_LENGTH 32
#define INIT_BYTES_LENGTH (INIT_BYTES_HEADER_LENGTH+APP_NAME_LENGTH)
